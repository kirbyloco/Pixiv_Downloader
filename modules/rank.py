...
def rank_content(login_session, modenum, contentnum, r18):
    url = ['https://www.pixiv.net/ranking.php?mode=' + mode[modenum] + '&content=' + content[contentnum] + '&p=1&format=json', 'https://www.pixiv.net/ranking.php?mode=' + mode[modenum] + '_r18&content=' + content[contentnum] + '&p=1&format=json']
